...
bounty-description-spear = Служба безопасности ГенШтаб переживает сокращение бюджета. Вам заплатят, если вы доставите набор копий.
...
bounty-description-rollerskates = Служба безопасности ГенШтаб предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
