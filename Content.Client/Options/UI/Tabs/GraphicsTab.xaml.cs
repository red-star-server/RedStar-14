...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        Control.AddOptionCheckBox(OrionCCVars.EnableLightsGlowing, LightingShaderCheckBox); // RS14
        ...
        public override void SaveValue()
        {
            switch (_dropDown.Button.SelectedId)
            {
                case QualityVeryLow:
                    ...
                    _cfg.SetCVar(OrionCCVars.EnableLightsGlowing, false); // RS14
                    break;
                case QualityLow:
                ...
                default: // = QualityMedium
                    ...
                    _cfg.SetCVar(CVars.LightBlur, true);
                    _cfg.SetCVar(OrionCCVars.EnableLightsGlowing, true); // RS14
                    break;
                case QualityHigh:
