...
reagent-desc-proto-nitrate = Летучий нитратный прекурсор, возникающий в экзотической атмосфере.

reagent-name-zauker = заукер
reagent-desc-zauker = Крайне едкий экспериментальный газ.

reagent-name-halon = галон
reagent-desc-halon = Газ для подавления огня, активно поглощающий кислород.
